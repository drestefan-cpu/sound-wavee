                ...
                >
                  ...
                  {activeMoonId === m.id && (
                    ...
                    >
                      ...
                      <span
                        className="absolute top-full mt-0.5 left-1/2 -translate-x-1/2 text-[8px] transition-opacity duration-300 whitespace-nowrap"
                        style={{ color: "#F0EBE3", opacity: 1 }}
                      >
                        @{m.username || "·"}
                      </span>
                    </div>
                  ...
                  {activeMoonId !== m.id && (
                    <span
                      ...
                      style={{ color: "#F0EBE3", opacity: !moonsFaded ? 1 : 0 }}
                    >
                      @{m.username || "·"}
                    </span>
                  )}
